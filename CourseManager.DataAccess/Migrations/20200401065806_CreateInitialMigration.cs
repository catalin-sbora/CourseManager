    ...
    public partial class CreateInitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursePresences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoursePresences_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CoursePresences_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursePresences_CourseId",
                table: "CoursePresences",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CoursePresences_StudentId",
                table: "CoursePresences",
                column: "StudentId");
